...
if(isset($_POST["tournament"])) $cust->tournament = $_POST["tournament"];
if(isset($_POST["record"]))     $cust->record = $_POST["record"];
...
switch ($fun) {
    ...
    case "delete_db_record":    $cust->delete_db_record($id);
        break;
    default: 
        echo "Error: Invalid function call (user.php)";
        exit();
        break;
}